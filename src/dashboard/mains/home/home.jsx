...
function HomeFunc() {
    ...
    useEffect(() => {
        const fetchIPDetails = async () => {
            try {
                const response = await fetch("https://bazaar-analyze-c1d62cd1ada0.herokuapp.com/api/locations/address");
                const data = await response.json();
    ...
    const fetchWeather = async (latitude, longitude) => {
        try {
            ...
            const url = `https://bazaar-analyze-c1d62cd1ada0.herokuapp.com/api/weather/${location}?lat=${latitude}&lon=${longitude}`;
